...
PocketDispatcher.PutFile(PocketDispatcher, str, str)
did not match C++ signature:
    PutFile(PocketDispatcher {lvalue}, std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >, std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >, bool): ArgumentError
    Traceback (most recent call last):
    File "/var/task/throughput.py", line 121, in lambda_handler
    pocket_write(p, jobid, iter, file_tmp, id)
    File "/var/task/throughput.py", line 14, in pocket_write
    r = pocket.put(p, src_filename, dst_filename, jobid)
    File "/var/task/pocket.py", line 55, in put
    res = pocket.PutFile(src_filename, set_filename)
    ArgumentError: Python argument types in
    PocketDispatcher.PutFile(PocketDispatcher, str, str)
    did not match C++ signature:
    PutFile(PocketDispatcher {lvalue}, std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >, std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >, bool)
